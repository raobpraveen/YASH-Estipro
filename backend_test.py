...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://project-calc-hub.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://project-calc-hub.preview.emergentagent.com/api")
