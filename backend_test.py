...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://project-pricing-4.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://project-pricing-4.preview.emergentagent.com/api")
