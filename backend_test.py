...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://estpro-payment-flow.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://estpro-payment-flow.preview.emergentagent.com/api")
