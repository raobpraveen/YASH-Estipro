...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://component-extract-17.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://component-extract-17.preview.emergentagent.com/api")
