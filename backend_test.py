...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://project-calc-dev.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://project-calc-dev.preview.emergentagent.com/api")
