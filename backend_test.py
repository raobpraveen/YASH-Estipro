...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://pricing-tool-staging.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://pricing-tool-staging.preview.emergentagent.com/api")
