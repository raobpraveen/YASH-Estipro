...
class ProjectEstimatorAPITester:
    def __init__(self, base_url="https://milestone-track-10.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing against: https://milestone-track-10.preview.emergentagent.com/api")
