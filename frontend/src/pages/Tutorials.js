...
const TUTORIALS = [
  ...
  },
  {
    ...
    description: "Define payment schedules per wave with target months, payment terms, and automatic amount calculation. Copy milestones across waves.",
    duration: "4 min",
    ...
    steps: [
      ...
      { target: "Each wave has its own section.", action: "Click the wave header to expand/collapse. The header shows Final Price, Payment %, and total amount." },
      { target: "Click '+ Add Milestone' within a wave.", action: "A new row appears. Fill in the Milestone Name, Target Month (M1, M2...), and Payment %. Amount auto-calculates." },
      { target: "Use 'Copy to Wave' for multi-wave projects.", action: "Click the 'Copy to Wave' dropdown next to Add Milestone and select a target wave. All milestones are duplicated with recalculated amounts." },
      { target: "Save with Ctrl+S or the Save All button.", action: "Click 'Save All' or press Ctrl+S. Milestones auto-recalculate when project data changes in the Estimator." },
    ],
    hasSlideshow: false,
    hasTour: false,
  },
  ...
  {
    id: "gantt-chart",
    title: "Phase Assignment & Gantt Chart",
    description: "Assign project phases to months and auto-generate a staircase Gantt chart. Set wave start offsets for multi-wave timelines.",
    duration: "3 min",
    category: "Core Features",
    icon: FileSpreadsheet,
    color: "bg-orange-500",
    steps: [
      { target: "Open the Estimator for a project.", action: "Save the project first if it's new. The Phase row and Gantt Chart section appear after save." },
      { target: "Look for the green 'Phase' row in the wave grid.", action: "Below the month headers (M1, M2...), you'll see a row of dropdowns. Each dropdown assigns a phase to that month." },
      { target: "Select phases from the dropdown.", action: "Choose from predefined options: Prepare, Explore, Realize, Deploy, Go-live, Hypercare, Design, Build, Test, UAT, Support. Or select '+ Custom...' to enter a custom phase name." },
      { target: "Example: M1=Prepare, M2-M3=Explore, M4-M6=Realize, M7=Go-live.", action: "Consecutive months with the same phase merge into a single bar in the Gantt chart." },
      { target: "Scroll down to the Timeline / Gantt Chart section.", action: "The chart auto-generates with a staircase layout — each phase gets its own row, cascading down like a waterfall." },
      { target: "For multi-wave projects, set the 'Starts at project M' value.", action: "In the wave header, enter the project month where this wave begins. E.g., if Wave 2 starts in M3, set it to 3. The Gantt chart reflects this offset." },
      { target: "Optionally upload a custom Gantt image.", action: "Click 'Upload Image' to add a custom timeline image alongside the auto-generated chart." },
      { target: "Save the project to persist phases.", action: "Press Ctrl+S or click Save. Phase assignments are stored per-wave and persist across sessions." },
    ],
    hasSlideshow: false,
    hasTour: false,
  },
