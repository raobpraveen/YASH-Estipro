...
const TUTORIALS = [
  ...
  {
    id: "gantt-chart",
    title: "Phase Ranges & Gantt Chart",
    description: "Define project phases with start/end ranges (half-month precision) and auto-generate a Gantt chart. Phases can overlap and the section is collapsible.",
    duration: "3 min",
    category: "Core Features",
    icon: FileSpreadsheet,
    color: "bg-orange-500",
    steps: [
      ...
      { target: "Set Start and End values with half-month precision.", action: "Use the numeric inputs (step 0.5). Example: Start=1, End=2 covers months 1-2. Start=1.5, End=3 means 'begin mid-month 1 through end of month 3'. Start=2.5, End=5 means 'begin mid-month 2 through end of month 5'." },
      { target: "Check the Timeline Preview.", action: "Below the phase list, continuous color-coded bars show each phase's position with precise half-month rendering." },
      { target: "Collapse the Phase Ranges section when done.", action: "Click the 'Phase Ranges' header to collapse it. A badge shows '3 phases' (or however many). This frees up screen space for the resource grid." },
      { target: "Scroll down to the Timeline / Gantt Chart section.", action: "The chart auto-generates with each phase as a separate bar. Overlapping phases are shown as stacked rows. Half-month boundaries render with precise positioning." },
      ...
      { target: "Save the project to persist phases.", action: "Press Ctrl+S or click Save. Phase ranges are stored per-wave and persist across sessions." },
    ],
    hasSlideshow: false,
    hasTour: false,
  },
